...
pub enum StructOptAttr {
    ...
    Manpage(Ident, LitStr),
    ManpageHeader(Ident, LitStr),
    ManpageFooter(Ident, LitStr),
        ...
        if input.peek(Token![=]) {
            ...
            if input.peek(LitStr) {
                ...
                match &*name_str {
                    ...
                    "manpage" => {
                        check_empty_lit("manpage");
                        Ok(Manpage(name, lit))
                    }

                    "manpage_header" => {
                        check_empty_lit("manpage_header");
                        Ok(ManpageHeader(name, lit))
                    }

                    "manpage_footer" => {
                        check_empty_lit("manpage_footer");
                        Ok(ManpageFooter(name, lit))
                    }
